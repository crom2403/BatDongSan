...
const SelectProvince = ({ onClose }) => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between py-4 px-6 border-b border-input">
      ...
      <div className="text-sm text-slate-900 py-4 px-6 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-5 gap-4">
            {provinces.map((el) => (
              <p
                className="cursor-pointer hover:text-blue-700 hover:bg-blue-50 px-1 rounded-sm font-semibold w-fit"
                key={el.idProvince}
              >
                {el.name}
              </p>
